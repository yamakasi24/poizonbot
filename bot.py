...
def callback_massage(callback):
    if callback.data == 'calculate':
        ...
        bot.send_message(callback.message.chat.id, f"❕Помимо Poizon, мы также можем выкупить и доставить товары с других китайских маркетплейсов: Taobao, Goofish (Xianyu), 95 и др."
                                                   ...
                                                   f"🐠Goofish — ресейл-площадка, много б/у товаров по сути как наш Авито. Можно найти редкие и лимитированные позиции или оригинальные вещи в хорошем состоянии по ценам ниже рынка. Есть возможность проверки на подлинность (~40¥).\n\n"
                                                   ...
                                                   f"Пример:\n"
                                                   f"Вы заказали товары на 1000¥\n\n"
                                                   f"1000 × 1.10 × 12 = 13200₽\n"
